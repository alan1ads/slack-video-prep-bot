...
app.view('video_processing_modal', async ({ ack, body, view, client }) => {
    ...
    for (let i = 0; i < variablesCount; i++) {
        ...
        const reverbLevel = Math.floor(Math.random() * 0.7); // Drastically reduced - almost always 0
        const delayLevel = Math.floor(Math.random() * 0.7); // Drastically reduced - almost always 0
        const pitchShift = (Math.random() * 0.2) - 0.1; // Reduced from ±0.25 to ±0.1 semitones (tiny)
        const distortion = Math.floor(Math.random() * 0.7); // Drastically reduced - almost always 0
        const noiseReduction = Math.floor(Math.random() * 1.5); // Reduced from 0-2 to mostly 0, occasionally 1
        const eqLowLevel = (Math.random() * 0.3) - 0.15; // Reduced from ±0.3 to ±0.15
        const eqMidLevel = (Math.random() * 0.3) - 0.15; // Reduced from ±0.3 to ±0.15
        const eqHighLevel = (Math.random() * 0.3) - 0.15; // Reduced from ±0.3 to ±0.15
        const compression = Math.floor(Math.random() * 1.5); // Reduced from 0-2 to mostly 0, occasionally 1
        const deEssing = Math.floor(Math.random() * 0.7); // Drastically reduced - almost always 0
                ...
                for (let i = 0; i < parameterSets.length; i++) {
                    ...
                    try {
                        ...
                        const processedPath = await processVideo(
                            ...
                            params.reverbLevel + (Math.random() * 0.06 - 0.03), // Further reduced to ±0.03
                            params.delayLevel + (Math.random() * 0.06 - 0.03),  // Further reduced to ±0.03
                            params.pitchShift + (Math.random() * 0.06 - 0.03), // Further reduced to ±0.03
                            params.distortion,
                            params.noiseReduction,
                            params.eqLowLevel + (Math.random() * 0.06 - 0.03), // Further reduced to ±0.03
                            params.eqMidLevel + (Math.random() * 0.06 - 0.03), // Further reduced to ±0.03
                            params.eqHighLevel + (Math.random() * 0.06 - 0.03), // Further reduced to ±0.03
                            params.compression,
                            params.deEssing,
